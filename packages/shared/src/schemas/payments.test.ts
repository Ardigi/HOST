...
describe('Payment Validation Schemas', () => {
	describe('newPaymentSchema', () => {
		...
		it('should enforce 4-digit card last four', () => {
		...
		it('should reject negative processor fees', () => {
			const invalidPayment = {
				venueId: 'venue-123',
				orderId: 'order-456',
				amount: 50.0,
		...
		it('should require venueId to be non-empty', () => {
			const invalidPayment = {
				venueId: '',
				orderId: 'order-456',
				amount: 25.0,
		...
		it('should require orderId to be non-empty', () => {
			const invalidPayment = {
				venueId: 'venue-123',
				orderId: '',
				amount: 25.0,
	...
	describe('paymentSchema (full payment)', () => {
		...
		it('should require id to be non-empty', () => {
			const invalidPayment = {
				id: '',
				venueId: 'venue-123',
				orderId: 'order-456',
